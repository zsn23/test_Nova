		...
		<Card
			...
			<VuiBox display='flex' flexDirection='column'>
				...
				<VuiTypography variant='button' color='text' fontWeight='regular' mb='30px'>
					Hello, Demo User! Your Account is verified.
				</VuiTypography>
				<Stack
					spacing='24px'
					background='#fff'
					...
					<VuiBox
						...
						<VuiBox sx={{ position: 'relative', display: 'inline-flex' }}>
							<CircularProgress variant='determinate' value={0} size={170} color='info' />
							<VuiBox display='flex' flexDirection='column' justifyContent='center' alignItems='center'>
								<VuiBox component='' src />
								<VuiTypography color='white' variant='h2' mt='2px' fontWeight='bold' mb='4px' sx={{ ml: '-160px' }}>
									100%
								</VuiTypography>
								<VuiTypography color='text' variant='caption' sx={{ ml: '-180px' }}>
									Verified
								</VuiTypography>
							</VuiBox>
						</VuiBox>
